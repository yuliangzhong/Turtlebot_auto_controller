...
class LocalSamplingPlanner:
    ...
    def plan(self):
        ...
        while not valid_point_found or counter < self.n_samples:
            ...
            _, is_safe = self._robot.check_move_feasible(x, y, 0.25)
            if is_safe:
                ...
                for i in range(self.n_yaw):
                    ...
                    samples.append([x + self._robot.position_x, y + self._robot.position_y, yaw])
                    local_samples.append([x,y,yaw])                    
        ...
        return result,samples,local_samples
